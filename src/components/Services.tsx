...
export default function Services() {
  const services = [
    ...
    },
    {
      ...
      description: "Production-grade security with automated compliance and monitoring",
  ...
  return (
    <section className="min-h-screen flex items-center py-20 relative">
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-slate-900 to-slate-900 pointer-events-none" />
